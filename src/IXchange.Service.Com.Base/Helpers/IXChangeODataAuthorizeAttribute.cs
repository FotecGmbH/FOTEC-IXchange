...
namespace IXchange.Service.Com.Base.Helpers
{
    ...
    public sealed class IXChangeODataAuthorizeAttribute : Attribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!context.HttpContext.TryGetExResearchInstituteFromHttpContext(out var researchInstitute) || (!researchInstitute?.HasAccess() ?? true))
            {
                // no access
