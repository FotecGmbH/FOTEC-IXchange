...
namespace BaseApp.ViewModel.Company
{
    ...
    public class VmCompany : VmProjectBase
    {
        ...
        /// <summary>
        /// Events hinzufuegen oder abhaengen
        /// </summary>
        /// <param name="detach">Abhaengen oder hinzufuegen</param>
        ...
        /// <summary>
        /// DcExGlobalConfigOnLoadingFromHostEvent
        /// </summary>
        ...
        /// <summary>
        /// DcExProjectsOnLoadingFromHostEvent
        /// </summary>
        /// <param name="sender">sender</param>
        /// <param name="e">e</param>
        ...
        /// <summary>
        /// DcCompanyUsersOnLoadingFromHostEvent
        /// </summary>
        /// <param name="sender">sender</param>
        /// <param name="e">e</param>
