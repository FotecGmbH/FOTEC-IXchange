...
namespace BaseApp.ViewModel
{
    ...
    public class VmMenu : VmProjectBase
    {
        ...
        public void UpdateMenu()
        {
            ...
            if (Dc?.CoreConnectionInfos == null! || !Dc.DeviceAndUserRegisteredLocal)
            {
                AddDefault();
            }
            else
            {
                ...
                CmdAllMenuCommands.Add(GCmdIotDevicesOverview);
                CmdAllMenuCommands.Add(GCmdMyRatings);
                CmdAllMenuCommands.Add(GCmdIncomeOutput);
                CmdAllMenuCommands.Add(GCmdNotifications);
                CmdAllMenuCommands.Add(GCmdAboOverview);
