    ...
    public class VmEditUser : VmProjectBase
    {
        ...
        public VmEditUser() : base(ResViewEditUser.LblTitle, subTitle: ResViewEditUser.LblSubTitle)
        {
            ...
            EntryLastName = new VmEntry(EnumVmEntryBehavior.StopTyping,
                ...
                maxChar: 50,
                showTitle: false);
            EntryPassword4NewUser = new VmEntry(EnumVmEntryBehavior.StopTyping,
                ResViewEditUserPassword.EntryTitleNewPassword,
                ResViewEditUserPassword.EntryPlaceholderNewPassword,
                showTitle: false,
                validateFunc: s =>
                {
                    if (Dc.DcExUser.Data.LoginConfirmed)
                    {
                        return (string.Empty, true);
                    }

                    return VmEntryValidators.ValidateFuncStringEmpty(s);
                },
                returnAction: () => { EntryPassword4NewUser?.ValidateData(); });
            ...
            if (!Dc.DcExUser.Data.LoginConfirmed)
            {
                EntryPassword4NewUser.ValidChanged += (sender, args) => View.CmdSaveHeader!.CanExecute();
            }
        }
        ...
        /// <summary>
        ///     Password für neuen User
        /// </summary>
        public VmEntry EntryPassword4NewUser { get; set; }
        ...
        protected override void InitializeCommands()
        {
            View.CmdSaveHeader = new VmCommand(ResViewEditUser.CmdSave, async () =>
            {
                ...
                if (!Dc.DcExUser.Data.LoginConfirmed)
                {
                    Dc.DcExUser.Data.PasswordHash4NewUser = AppCrypt.CumputeHash(EntryPassword4NewUser.Value);
                }
        ...
        private bool CanExecuteCmdSave()
        {
            ...
            if (!EntryFirstName.DataValid || !EntryLastName.DataValid || (!Dc.DcExUser.Data.LoginConfirmed && !EntryPassword4NewUser.DataValid))
            {
                return false;
            }
