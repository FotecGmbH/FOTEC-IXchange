...
namespace BaseApp
{
        ...
        where T2 : IBissModel
    {
        ...
        /// <summary>
        /// Liste der INotifyPropertyChanged
        /// </summary>
        private List<INotifyPropertyChanged> _iNotifyPropertyChangedList = null!;

        /// <summary>
        /// Ob navigiert ueber NavToViewWithResult
        /// </summary>
        ...
        /// <summary>
        /// Letzter check save command ergebnis
        /// </summary>
