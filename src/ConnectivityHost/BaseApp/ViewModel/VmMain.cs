...
namespace ConnectivityHost.BaseApp.ViewModel
{
    ...
    public class VmMain : VmProjectBase
    {
        ...
        ///     Link zu Playstore
        /// </summary>
        public string PlaystoreLink => "https://play.google.com/";

        /// <summary>
        ///     Link zu Appcenter
        /// </summary>
        public string AppcenterLink => "https://appcenter.ms/";

        /// <summary>
        ///     Link zu Devops
        /// </summary>
        public string DevopsLink => "https://dev.azure.com/fotec/";

        /// <summary>
        ///     Link zu Firebase
        /// </summary>
        public string FirebaseLink => "https://firebase.google.com/";

        /// <summary>
        ///     Link zum Appstore
        /// </summary>
        public string AppstoreLink => "https://www.apple.com/at/app-store/";
