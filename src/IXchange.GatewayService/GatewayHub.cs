...
// 
// Erstversion vom 14.01.2022 14:45
...
namespace IXchange.GatewayService;
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        List<long> newValuesFromMeasurementDefinitions = new List<long>();
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        try
        {
            ...
            _ = Task.Run(async () =>
            {
                await _triggerAgent.IotDeviceStatusChanged(iot.Id).ConfigureAwait(false);
            });
