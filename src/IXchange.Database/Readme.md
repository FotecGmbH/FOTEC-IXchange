...
## Umstellung auf Postgres-DB:
	...
	- In WebSettings.cs (oder über bs.xml): Datenbank-Properties (aus IAppSettingsDataBase) richtig stellen (DERZEIT nur Property "ConnectionStringDbServer" ändern, siehe Kommentar bei Property, alles andere bleibt gleich)
